...
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "QRImobCode.settings")
...
class Service(DjangoService):
    ...
    _svc_name_ = "django-qrimobcode-service"
    _svc_display_name_ = "Django qrimobcode background service"
